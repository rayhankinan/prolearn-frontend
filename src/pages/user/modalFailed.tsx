...
const ModalFailed = ({open, onClose, error}: ModalFailedProps) => {
    ...
    return (
        <div>
                ...
                >
                    <div className="relative top-80 mx-auto p-5 border w-96 shadow-lg rounded-xl bg-white shadow-xl border-2 border-red-500">
                        <div className="mt-3 text-center">
                            <div className="mx-auto flex items-center justify-center h-16 w-16 border-2 border-red-500 rounded-full bg-red-100">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-6 w-6 text-red-600">
                                <path fill="none" stroke="currentColor" stroke-width="2" d="M18 6L6 18"></path>
                                <path fill="none" stroke="currentColor" stroke-width="2" d="M6 6L18 18"></path>
                            </svg>
