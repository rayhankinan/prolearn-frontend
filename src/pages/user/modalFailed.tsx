...
const ModalFailed = ({ open, onClose, error }: ModalFailedProps) => {
  return (
    <div>
      <div className="fixed inset-0 bg-red-200 bg-opacity-25 overflow-y-auto">
        <div
          className="relative top-80 mx-auto p-5 border w-96 shadow-lg
        rounded-xl bg-white shadow-xl border-2 border-red-500"
        >
          <div className="mt-3 text-center">
            <div
              className="mx-auto flex items-center justify-center h-16
